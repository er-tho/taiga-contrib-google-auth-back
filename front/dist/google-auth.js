angular.module("templates").run(
    ["$templateCache", function($templateCache) {
      $templateCache.put("/plugins/google-auth/google-auth.html",
          "\n<div tg-google-login-button=\"tg-google-login-button\"><a href=\"\" title=\"Enter with your google account\" class=\"button button-auth\">" +
          "<img src=\"/plugins/google-auth/images/google-logo.png\" alt=\"\"/><span>Sign in with Google</span></a></div>");
    }
    ]
);
